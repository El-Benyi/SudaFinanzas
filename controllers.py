...
"""
from models import db, Usuario, Ingreso, Activo, Dinero, PagoReemplazo, PagoHorasExtra, PagoSueldoCliente, RetiroActivo, CatActivo
...
class ControladorIngreso:
    @staticmethod
    def ingresos(cliente,establecimiento,responsable_pago,num_factura,dia,mes,año,medio_pago,monto,descuento,total_descuento,total_utilidad,concepto_pago,motivo_ingreso):
...
class ControladorEgreso:
    @staticmethod
    def horas_extra(nombre, rut, dia_trabajado, turno, monto_pagar, nombre_paga):
        ...
        h_extra.turno = turno
        h_extra.monto_pagar = monto_pagar
    ...
    def pago_reemplazo(nombre, rut, dia_trabajado,turno,monto_pagar,nombre_paga,pago_cotizacion,pago_sueldo):
        ...
        p_reemplazo.nombre = nombre
        p_reemplazo.rut = rut
        p_reemplazo.dia_trabajado = dia_trabajado
        p_reemplazo.turno = turno
        p_reemplazo.monto_pagar = monto_pagar
        p_reemplazo.nombre_paga = nombre_paga
        p_reemplazo.pago_cotizacion = pago_cotizacion
        p_reemplazo.pago_sueldo = pago_sueldo
